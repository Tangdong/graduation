...
QT_MOC_LITERAL(1, 8, 11), // "sigCloseDlg"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14) // "OnCloseClicked"

    },
    "DDialog\0sigCloseDlg\0\0OnCloseClicked"
};
...
void DDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DDialog *_t = static_cast<DDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigCloseDlg(); break;
        ...
        {
            typedef void (DDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DDialog::sigCloseDlg)) {
                *result = 0;
                return;
            }
        }
