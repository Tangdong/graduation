...
QT_MOC_LITERAL(1, 15, 13), // "OnOkBtnClienk"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "BookManagement\0OnOkBtnClienk\0"
};
...
const QMetaObject BookManagement::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BookManagement.data,
      qt_meta_data_BookManagement,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BookManagement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BookManagement.stringdata0))
        return static_cast<void*>(const_cast< BookManagement*>(this));
