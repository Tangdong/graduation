...
QT_MOC_LITERAL(3, 25, 11) // "onOkClicked"

    },
    "DialogWidget\0onCloseDlg\0\0onOkClicked"
};
...
void DialogWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DialogWidget *_t = static_cast<DialogWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DialogWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DialogWidget.data,
      qt_meta_data_DialogWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DialogWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogWidget.stringdata0))
        return static_cast<void*>(const_cast< DialogWidget*>(this));
