...
struct qt_meta_stringdata_DLineEdit_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DLineEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DLineEdit_t qt_meta_stringdata_DLineEdit = {
    {
QT_MOC_LITERAL(0, 0, 9) // "DLineEdit"
...
const QMetaObject DLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_DLineEdit.data,
      qt_meta_data_DLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DLineEdit.stringdata0))
